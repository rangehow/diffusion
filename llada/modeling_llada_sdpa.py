...
class LLaDAModel(nn.Module):
    ...
    def forward(
        ...
        if (
            ...
            or past_key_values is not None  # needed for k/v cache correctness
        ):

            if attention_bias is None:
                # ✅ 不创建任何 bidirectional bias，避免显存浪费
                attention_bias = None
...
class LLaDAModelLM(PreTrainedModel):
    ...
    _tied_weights_keys = {"transformer.ff_out.weight": "transformer.wte.weight"}
