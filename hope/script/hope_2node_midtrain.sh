...
declare -A default_config=(
    [batch_size]=8
    [grad_accum_steps]=8
    [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/modernbert_large.json"
    [mode]="niu"
    [mlm_prob_start]=1
    [mlm_prob_end]=0.0001
    [dataset_name]="fineweb_10b,mmlu,gsm8k,python,winogrande,hellaswag"
    [MAX_LENGTH]=2048
    [EPOCHS]=1
...
#
task_overrides=(
    # '([hope_name]="niu_1B_100b_finefineweb"  [MAX_LENGTH]=1024 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/modernbert_1B.json" [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
    # '([hope_name]="niu_1B_100b_finefineweb_lowvariance"  [MAX_LENGTH]=1024 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/modernbert_1B.json" [mlm_prob_start]=0.7 [mlm_prob_end]=0.3)'
    '([hope_name]="llada_fix_pad"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/llada_1B_100b_pretrain/checkpoint-309339" [batch_size]=4 [grad_accum_steps]=16 [mode]="llada")'
    # '([hope_name]="arm_1B_100b_2node"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/arm_1B_100b_2node/checkpoint-309339" [batch_size]=4 [grad_accum_steps]=16 [mlm_prob_start]=0.9 [mlm_prob_end]=0.1 [mode]="llama")'

    # '([hope_name]="niu_1B_100b_2node"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_100b_2node/checkpoint-309339" [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
    # '([hope_name]="niu_1B_100b_lowvariance_2node"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_100b_lowvariance_2node/checkpoint-309339" [mlm_prob_start]=0.7 [mlm_prob_end]=0.3)'
    # '([hope_name]="niu_1B_tight_2node"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_tight_2node/checkpoint-309339" [tail_bias_factor]=1 [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
   
    # '([hope_name]="niu_1B_100b_daum_2node"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_100b_daum_2node/checkpoint-309339" [use_daum]=True [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
    # '([hope_name]="niu_1B_100b_daum_loose_2node" [tail_bias_factor]=100  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_100b_daum_loose_2node/checkpoint-309339" [use_daum]=True [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'


    # 废弃实验
    # '([hope_name]="niu_1B_100b_fast_2node"  [MAX_LENGTH]=2048 [model_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/ruanjunhao04/diffusion/model_config/modernbert_1b_swa.json" [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
)


HOPE_TEMPLATE="train_2node.hope"
MAIN_SCRIPT_PATH="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/pretrain/midtrain.sh"
BASE_OUTPUT_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/midtrain"
...
for override_str in "${task_overrides[@]}"; do
    ...
    unset hope_name output_subdir  \
          batch_size grad_accum_steps model_path mode mlm_prob_start mlm_prob_end \
    ...
    # 4. 构建 worker 命令 (无需改动)
    #    用法: bash train.sh <OUTPUT_DIR> <MASK_PROB> <RANDOM_PROB> <MLM_PROB_START> <MLM_PROB_END> <BATCH_SIZE> <GRAD_ACCUM_STEPS> <model_path> <MODE>
