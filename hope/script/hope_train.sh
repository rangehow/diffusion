...
task_overrides=(
    ...
    '([hope_name]="llada_1B_100b" [dataset_name]="filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/llada_1b.json" [batch_size]=4 [grad_accum_steps]=16 [mlm_prob_start]=0.9 [mlm_prob_end]=0.1 [mode]="llada")'
    '([hope_name]="arm_1B_100b" [dataset_name]="filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/llama_1b.json" [batch_size]=4 [grad_accum_steps]=16 [mlm_prob_start]=0.9 [mlm_prob_end]=0.1 [mode]="llama")'
    
    '([hope_name]="niu_1B_100b" [dataset_name]="filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/modernbert_1b.json" [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
    '([hope_name]="niu_1B_100b_lowvariance" [dataset_name]="filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/modernbert_1b.json" [mlm_prob_start]=0.7 [mlm_prob_end]=0.3)'
    '([hope_name]="niu_1B_tight" [dataset_name]="filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/modernbert_1b.json" [tail_bias_factor]=1 [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
    '([hope_name]="niu_1B_100b_fast" [dataset_name]="filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/ruanjunhao04/diffusion/model_config/modernbert_1b_swa.json" [mlm_prob_start]=0.99999 [mlm_prob_end]=0.00001)'
