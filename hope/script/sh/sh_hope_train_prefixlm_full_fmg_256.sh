...
echo "=== PrefixLM 1B Full Training (fmg 256卡版) ==="
...
TEMP_HOPE="prefixlm_full_train_fmg_256.hope"
...
if [ ${HOPE_EXIT} -eq 0 ]; then
    echo "PrefixLM full training job (fmg 256-GPU) submitted successfully."
else
