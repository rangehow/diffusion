...
echo "=== PrefixLM 1B Full Training (m17 512卡版) ==="
...
TEMP_HOPE="prefixlm_full_train_m17_512.hope"
...
if [ ${HOPE_EXIT} -eq 0 ]; then
    echo "PrefixLM full training job (m17 512-GPU) submitted successfully."
else
