#!/bin/bash
# =========================================================================
#  速度基准测试 — 1 node (8 GPUs), 500 steps — 仅 CARD
#  严格对齐: bs=4, ga=16, 8 GPUs → eff_batch = 512 seqs/step
#
#  沿用 sh_benchmark_1node.sh 的提交方式:
...
# =========================================================================
#  submit_job: 复用 sh_benchmark_1node.sh 的 sed + hope run 逻辑
# =========================================================================
submit_job() {
    local JOB_NAME=$1
...
echo ""
echo "=== CARD benchmark job submitted ==="
