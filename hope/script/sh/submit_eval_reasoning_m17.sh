#!/bin/bash
# =========================================================================
#  Submit reasoning eval to M17 queue as TWO 1-node jobs (8 GPUs each).
...
#    bash script/sh/submit_eval_reasoning_m17.sh                  # 110m
#    bash script/sh/submit_eval_reasoning_m17.sh --size 400m
#    bash script/sh/submit_eval_reasoning_m17.sh --dry-run
# =========================================================================
set -euo pipefail
...
HOPE_TEMPLATE="${HOPE_DIR}/hope/reasoning_m17_1node.hope"
