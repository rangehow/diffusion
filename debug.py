...
from .modeling_niu_daum import ModernBertForDiffusionLM
...
def main():
    ...
    # model.save_pretrained('/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/ruanjunhao04/models/llama_1b')
    # tokenizer.save_pretrained('/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/ruanjunhao04/models/llama_1b')
