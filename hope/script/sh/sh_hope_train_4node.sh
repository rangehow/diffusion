...
task_overrides=(
    ...
    '([hope_name]="llm_platform_consumer_submit-2026-01-06-16-26-33" [output_subdir]="bd3lm_main_exp" [dataset_name]="sh_filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/ruanjunhao04/diffusion/model_config/bd3lm_1b.json" [batch_size]=2 [grad_accum_steps]=64  [mode]="bd3lm")'
...
HOPE_TEMPLATE="h800_hope_sh.hope"
