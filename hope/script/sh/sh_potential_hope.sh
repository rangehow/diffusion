...
declare -A default_config=(
    ...
    [mlm_prob_start]=1
    [mlm_prob_end]=0.0001
    [dataset_name]="sh_fineweb_edu_1b"
    [MAX_LENGTH]=2048
    [EPOCHS]=100
...
#
task_overrides=(
    # '([hope_name]="mdlm_1B_fineweb_edu_100b_potential"  [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/llada_1b.json"  [mode]="mdlm")'
    # '([hope_name]="arm_1B_fineweb_edu_100b_potential"  [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/llama_1b.json" [batch_size]=4 [grad_accum_steps]=16  [mode]="llama")'

    '([hope_name]="niu_1B_fineweb_edu_100b_potential_fix"  [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/ruanjunhao04/diffusion/model_config/modernbert_1b.json")'

    # '([hope_name]="bd3lm_1B_fineweb_edu_100b_potential"  [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_config/bd3lm_1b.json" [batch_size]=2 [grad_accum_steps]=32 [mode]="bd3lm")'

)

/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/ruanjunhao04/diffusion/hope/hope/h800_sh_2node.hope
HOPE_TEMPLATE="../../hope/h800_sh_2node.hope"
MAIN_SCRIPT_PATH="sh_potential.sh"
