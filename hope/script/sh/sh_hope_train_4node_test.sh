...
task_overrides=(
    ...
    # '([hope_name]="llm_platform_nlp_api_serving-2025-12-03-mdlm" [dataset_name]="sh_filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/ruanjunhao04/diffusion/model_config/llada_1b.json"  [mode]="mdlm")'
    # '([hope_name]="llm_platform_nlp_api_serving-2025-12-03-niu" [dataset_name]="sh_filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/ruanjunhao04/diffusion/model_config/modernbert_1b.json"  [mode]="niu")'
    '([hope_name]="llm_platform_consumer_submit-2026-01-06-16-26-33" [output_subdir]="llm_platform_nlp_api_serving-2025-12-03-bd3lm" [dataset_name]="sh_filtered_finefineweb" [MAX_LENGTH]=2048 [config_path]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/ruanjunhao04/diffusion/model_config/bd3lm_1b.json" [batch_size]=2 [grad_accum_steps]=32  [mode]="bd3lm")'
...
HOPE_TEMPLATE="hope_sh_test.hope"
MAIN_SCRIPT_PATH="sh_train.sh"
...
for override_str in "${task_overrides[@]}"; do
    ...
    hope run "${temp_hope_file}" -Dhope.resource.experiment=flash_2512_arena_h800 -Dmlp.sche.priority=P0  &
