...
# ==============================================================================
task_overrides=(
    '([hope_name]="eval_mdlm_1B_fineweb" [target_parent_dir]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/mdlm_1B_fineweb_edu_100b_potential" [batch_model_type]="discrete_diffusion" [tasks_json]="{\"hellaswag\":10}")'
    ...
    '([hope_name]="eval_niu_1B_fineweb" [target_parent_dir]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_fineweb_edu_100b_potential" [batch_model_type]="causal" [tasks_json]="{\"hellaswag\":10}")'
    '([hope_name]="eval_niu_1B_fineweb_mc" [target_parent_dir]="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/INS/ruanjunhao04/diffusion/model_output/niu_1B_fineweb_edu_100b_potential" [batch_model_type]="discrete_diffusion" [tasks_json]="{\"hellaswag\":10}")'
)
...
# 3. 脚本固定配置 (通常无需修改)
# ==============================================================================
HOPE_TEMPLATE="train_debug.hope"
